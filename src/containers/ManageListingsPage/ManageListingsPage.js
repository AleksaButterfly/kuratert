...
const IconEdit = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M11.3333 2.00004C11.5084 1.82494 11.7163 1.68605 11.9451 1.59129C12.1739 1.49653 12.4191 1.44775 12.6667 1.44775C12.9143 1.44775 13.1594 1.49653 13.3882 1.59129C13.617 1.68605 13.8249 1.82494 14 2.00004C14.1751 2.17513 14.314 2.383 14.4088 2.61178C14.5035 2.84055 14.5523 3.08575 14.5523 3.33337C14.5523 3.58099 14.5035 3.82619 14.4088 4.05497C14.314 4.28374 14.1751 4.49161 14 4.66671L5 13.6667L1.33333 14.6667L2.33333 11L11.3333 2.00004Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const IconTrash = () => (
  <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    />
    <path
      d="M5.33333 4.00001V2.66668C5.33333 2.31305 5.47381 1.97392 5.72386 1.72387C5.97391 1.47382 6.31304 1.33334 6.66667 1.33334H9.33333C9.68696 1.33334 10.0261 1.47382 10.2761 1.72387C10.5262 1.97392 10.6667 2.31305 10.6667 2.66668V4.00001M12.6667 4.00001V13.3333C12.6667 13.687 12.5262 14.0261 12.2761 14.2762C12.0261 14.5262 11.687 14.6667 11.3333 14.6667H4.66667C4.31304 14.6667 3.97391 14.5262 3.72386 14.2762C3.47381 14.0261 3.33333 13.687 3.33333 13.3333V4.00001H12.6667Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
const getStatusLabel = (state, intl) => {
  ...
  if (state === 'pendingApproval')
    return intl.formatMessage({ id: 'ManageListingsPage.statusPending' });
                          ...
                          <td>
                            <span
                              className={`${css.statusBadge} ${
                                isOutOfStock ? css.statusOutOfStock : getStatusBadgeClass(state)
                              }`}
                            >
                              {isOutOfStock
                            ...
                            <div className={css.actionButtons}>
                              <NamedLink
                                ...
                                params={{
                                  id: listingId,
                                  slug:
                                    listing.attributes.title?.replace(/\s+/g, '-').toLowerCase() ||
                                    'draft',
                              ...
                              <button
                                ...
                                onClick={() =>
                                  isDraft
                                    ? openDiscardDraftModal(listing.id)
                                    : onCloseListing(listing.id)
                                }
                                disabled={!!closingListing || !!openingListing}
                                title={intl.formatMessage({
                                  id: isDraft
                                    ? 'ManageListingsPage.discardDraft'
                                    : 'ManageListingsPage.closeListing',
                                })}
                              >
                                <IconTrash />
                              </button>
                              <div className={css.moreButtonWrapper}>
                                <button
                                  ...
                                  title={intl.formatMessage({
                                    id: 'ManageListingsPage.moreActions',
                                  })}
                                >
                                  <IconMore />
                                </button>
