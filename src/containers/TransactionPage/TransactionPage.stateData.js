...
import { getStateDataForNegotiatedPurchaseProcess } from './TransactionPage.stateDataNegotiatedPurchase.js';
...
export const getStateData = (params, process) => {
  ...
  } else if (processName === NEGOTIATED_PURCHASE_PROCESS_NAME) {
    return getStateDataForNegotiatedPurchaseProcess(params, processInfo());
  } else {
    return {};
  }
};
